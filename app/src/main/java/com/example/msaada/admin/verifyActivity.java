...
import com.example.msaada.recyclerviews.recycleverifycontributions;
...
public class verifyActivity extends AppCompatActivity {
            ...
            Response.Listener<JSONObject> successListener = response -> {
                ...
                try {
                    ...
                    for (int i = 0; i < list.length(); i++) {
                        ...
                        try {
                            Anime anime = Anime.verifycontributions(list.getJSONObject(i));
                            ...
                            anime.setAmountt(anime.getAmountt());
                            if(anime.getStatus().equals("1")){
                                anime.setStatus("Verified");
                            }else {
                                anime.setStatus("Unverified");
                            }
                            ...
                            Toast.makeText(verifyActivity.this,"No contribution found with the name provided",Toast.LENGTH_LONG).show();
                            progressDialog.dismiss();
    ...
    private void setuprecycleview(List<Anime> lstAnime) {
        recycleverifycontributions myadapter = new recycleverifycontributions(this, lstAnime);
